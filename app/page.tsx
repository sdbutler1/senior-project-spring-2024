...
export default function Home() {
  ...
  return (
    <div className="relative h-full w-full flex flex-col items-center justify-start ">
      ...
      <div className="relative w-full h-[45rem] flex flex-col items-center justify-center">
        <div className="absolute top-5 left-0 text-[1.5rem] text-black">
          <ul className="w-24 h-30 text-sm md:text-lg lg:text-xl" ref={scope}>
            <li className="opacity-0 w-fit px-4 py-1 rounded-r-full bg-shaw-yellow my-1 shadow-lg">
              Respect
            </li>
            <li className="opacity-0 w-fit px-4 py-1 rounded-r-full bg-shaw-yellow my-1 shadow-lg">
              Integrity
        ...
        <div className="h-[40%] lg:h-[50%] flex justify-center z-10 ">
          <div className="w-[80%] md:w-[50%] text-2xl md:text-4xl">
            <h1 className="text-slate-700 w-fit flex items-center justify-center gap-2">
              <span className="text-shaw-yellow font-extrabold">Hello </span>
              Dr. Brown,
              <Image
                src={shawBear}
                alt="Shaw Bear Icon"
            ...
            <p className="text-xl md:text-2xl font-light">
              Welcome to the Shaw University{" "}
              <span className="">Department of Computer Science</span>.
            </p>
            <div className="mt-5 w-full text-lg flex flex-col items-center justify-center gap-2">
              <Link
                href={"/"}
                className="w-full text-center px-4 py-1 bg-shaw-garnet/80 hover:bg-shaw-garnet hover:text-shaw-yellow duration-100 hover:scale-105 text-white font-bold rounded"
              >
                Profile
              </Link>
              <Link
